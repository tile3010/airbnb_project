...
const ButtonHeader: React.FC<TProps> = ({children}: TProps) => {
  ...
  return (
    <>
      <Button type="primary" style={{outline: 'unset',width:'7.7rem', height: '4.2rem', padding: 0, borderRadius: '50px'}} onClick={() => setModal1Open(true)}>
        {children}
      </Button>
      <Modal
